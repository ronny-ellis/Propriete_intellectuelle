 ...
 */
final class Version20250121110402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ip_right (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, type VARCHAR(255) NOT NULL, date_depot DATE NOT NULL, date_expiration DATE NOT NULL, territoire VARCHAR(255) NOT NULL, INDEX IDX_C9DE8CF979F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE licenses (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, territoire VARCHAR(255) NOT NULL, royalties NUMERIC(10, 0) NOT NULL, licencie VARCHAR(255) NOT NULL, INDEX IDX_7F320F3F79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ip_right ADD CONSTRAINT FK_C9DE8CF979F37AE5 FOREIGN KEY (id_user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ip_right DROP FOREIGN KEY FK_C9DE8CF979F37AE5');
